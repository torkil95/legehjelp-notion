...
export const rootNotionPageIdFraser: string = parsePageId(
  getSiteConfig('rootNotionPageIdFraser'),
  { uuid: false }
)

if (!rootNotionPageIdFraser) {
  throw new Error('Config error invalid "rootNotionPageIdFraser"')
}
